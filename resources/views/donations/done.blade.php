                    ...
                    <div class="row m0 widget widget-similar-project widget-similar">
                        ...
                        <div class="similar-project">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10"> <h4  style="text-transform: none;">  {{ Config::get('app.payments_config.'.$donor->currency) }}</h4> </div>

                                <div class="col-sm-2">  <h4> Txid: </h4> </div>
                                <div class="col-sm-10"> <h4>  {{ $donor->txid }}</h4> </div>
